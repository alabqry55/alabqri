...
var SAMPLE_CERTIFICATES = { "ABQ-2026-00001": { certificateNumber: "ABQ-2026-00001", traineeName: "\u0645\u062A\u062F\u0631\u0628 \u0646\u0645\u0648\u0630\u062C\u064A", programName: "\u062F\u0628\u0644\u0648\u0645\u0629 \u0627\u0644\u062A\u0623\u0635\u064A\u0644 \u0627\u0644\u0645\u0646\u0647\u062C\u064A", hours: "50", issueDate: "2026-01-15", issuer: "\u0645\u0631\u0643\u0632 \u0627\u0644\u0639\u0628\u0642\u0631\u064A \u0644\u0644\u062A\u062F\u0631\u064A\u0628 \u0648\u0627\u0644\u062A\u0637\u0648\u064A\u0631", status: "valid" }, "ABQ-2026-00002": { certificateNumber: "ABQ-2026-00002", traineeName: "\u0645\u062A\u062F\u0631\u0628 \u0646\u0645\u0648\u0630\u062C\u064A 2", programName: "\u0628\u0631\u0646\u0627\u0645\u062C \u0645\u0631\u0635\u062F \u0627\u0644\u0627\u062A\u0632\u0627\u0646", hours: "30", issueDate: "2026-03-20", issuer: "\u0645\u0631\u0643\u0632 \u0627\u0644\u0639\u0628\u0642\u0631\u064A \u0644\u0644\u062A\u062F\u0631\u064A\u0628 \u0648\u0627\u0644\u062A\u0637\u0648\u064A\u0631", status: "valid" } };
async function onRequestPost({ request, env: env2 }) {
  ...
  try {
    ...
    if (!certNumber) {
      return new Response(JSON.stringify({ valid: false, message: "\u0644\u0645 \u064A\u062A\u0645 \u0625\u062F\u062E\u0627\u0644 \u0631\u0642\u0645 \u0634\u0647\u0627\u062F\u0629." }), { status: 400, headers: corsHeaders });
    }
    const cert = SAMPLE_CERTIFICATES[certNumber];
    if (cert && cert.status === "valid") {
      return new Response(JSON.stringify({ valid: true, certificateNumber: cert.certificateNumber, traineeName: cert.traineeName, programName: cert.programName, hours: cert.hours, issueDate: cert.issueDate, issuer: cert.issuer }), { status: 200, headers: corsHeaders });
    } else if (cert && cert.status === "expired") {
      return new Response(JSON.stringify({ valid: false, message: "\u0647\u0630\u0647 \u0627\u0644\u0634\u0647\u0627\u062F\u0629 \u0644\u0645 \u062A\u0639\u062F \u0633\u0627\u0631\u064A\u0629." }), { status: 200, headers: corsHeaders });
    } else {
      return new Response(JSON.stringify({ valid: false, message: "\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0634\u0647\u0627\u062F\u0629 \u0628\u0647\u0630\u0627 \u0627\u0644\u0631\u0642\u0645." }), { status: 404, headers: corsHeaders });
    }
  } catch (err) {
    return new Response(JSON.stringify({ valid: false, message: "\u062D\u062F\u062B \u062E\u0637\u0623 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u0627\u0644\u0637\u0644\u0628." }), { status: 500, headers: corsHeaders });
  }
}
__name(onRequestPost, "onRequestPost");
async function onRequestGet({ request }) {
  const headers = { "Content-Type": "application/json", "Access-Control-Allow-Origin": "*" };
  return new Response(JSON.stringify({ endpoint: "/api/verify-certificate", method: "POST", description: "\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0634\u0647\u0627\u062F\u0627\u062A \u0645\u0631\u0643\u0632 \u0627\u0644\u0639\u0628\u0642\u0631\u064A" }), { status: 200, headers });
}
...
async function onRequestGet2({ env: env2 }) {
  ...
  try {
    ...
    const row = await env2.DB.prepare(`SELECT total, updated_at FROM visitors WHERE id = 1`).first();
    return json({
...
// api/feedback.js
var ALLOWED_RATINGS = /* @__PURE__ */ new Set(["excellent", "good", "average", "suggestion"]);
var BLOCKED_WORDS = ["\u0643\u0644\u0628", "\u062D\u0645\u0627\u0631", "\u063A\u0628\u064A", "\u0644\u0639\u0646\u0629", "fuck", "shit", "bitch", "asshole", "idiot"];
async function onRequest({ request, env: env2 }) {
  if (!env2.DB) return json2({ error: "D1 binding DB is not configured." }, 500);
  try {
    if (request.method === "GET") {
      return await getFeedback(env2.DB);
    }
    if (request.method !== "POST") {
      return json2({ error: "Method not allowed." }, 405, { allow: "GET, POST" });
    }
    ...
    if (action === "like") {
      ...
      return json2({ ok: true, likes: Number(row?.likes || 0) });
    }
    if (action === "comment") {
      const name = cleanText(body.name, 80) || "\u0632\u0627\u0626\u0631";
      const text = cleanText(body.text, 1e3);
      const rating = String(body.rating || "");
      if (!text) return json2({ error: "\u0627\u0644\u062A\u0639\u0644\u064A\u0642 \u0641\u0627\u0631\u063A." }, 400);
      if (!ALLOWED_RATINGS.has(rating)) return json2({ error: "\u062A\u0642\u064A\u064A\u0645 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D." }, 400);
      if (containsBlockedWord(name) || containsBlockedWord(text)) {
        return json2({ error: "\u064A\u0631\u062C\u0649 \u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0646\u0635 \u0642\u0628\u0644 \u0627\u0644\u0625\u0631\u0633\u0627\u0644." }, 400);
      }
      ...
      return json2({ ok: true, comment });
    }
    if (action === "delete") {
      const adminKey = env2.FEEDBACK_ADMIN_KEY;
      ...
      if (!Number.isInteger(id) || id < 1) {
        return json2({ error: "Invalid comment id." }, 400);
      }
      await env2.DB.prepare(`DELETE FROM feedback WHERE id = ?`).bind(id).run();
      return json2({ ok: true, id });
    }
    return json2({ error: "Unknown action." }, 400);
  } catch (error3) {
    return json2({ error: "Feedback service error." }, 500);
  }
}
...
__name(getFeedback, "getFeedback");
...
// ../.wrangler/tmp/pages-97HL6r/functionsRoutes-0.07509755625812742.mjs
var routes = [
  {
